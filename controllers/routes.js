...
router.put('/comments/:id', (req, res)=>{
    Students.findOneAndUpdate(req.params.id, {$set : {"status.$[t].comments" : req.body.comments, "confirm": req.body.confirm}},{arrayFilters : [{"t._id" : req.params.id}]},{new:true}, (err, updatedComments)=>{
